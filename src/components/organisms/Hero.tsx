    ...
    <section className={`bg-gray-900 py-4 lg:py-4 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          {/* Main Heading */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight animate-fade-in">
            <span className="block">The Voice AI platform for</span>
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in animate-delay-200">
            Build with the most accurate, realistic, and cost-effective APIs for speech-to-text, text-to-speech,
            and voice agents. Trusted by 200,000+ AI builders and leading enterprises. Available in real-time
